...
void joystick_init(void) {
    // Configure UP (P1.29)
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 26); // Clear function bits for P1.29 (bits 26,27)
    ...
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3 << 20); // Clear function bits for P1.26
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1 << 26); // Set P1.26 as input
